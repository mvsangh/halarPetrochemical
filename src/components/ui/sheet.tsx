  ...
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        {children}
        <SheetPrimitive.Close className="absolute right-6 top-6 z-[210] p-3 bg-secondary/80 backdrop-blur-md rounded-full border border-primary/10 hover:bg-accent hover:text-accent-foreground transition-all shadow-xl group/close">
          <X className="h-5 w-5" />
